      ...
      <div className="min-h-screen bg-[#F8FAFC] text-[#0A1D56] mt-8 rounded-2xl shadow-lg">
        ...
        <header className="text-center py-10">
          <h1 className="text-4xl md:text-5xl font-extrabold">
            Appointment{" "}
            <span className="text-[#004AAD]">Scheduling</span>
          </h1>
        ...
        <section className="px-6 md:px-20 py-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
            <div className="bg-white shadow-md rounded-2xl p-6 border-t-4 border-[#004AAD] hover:shadow-xl transition">
              <h3 className="text-xl font-semibold">Step 1: Fill Out Your Details</h3>
              <p className="mt-2 text-sm text-gray-600">
                Enter your Full Name, Age, Civil Status, and Address to begin your booking.
              </p>
            </div>
            <div className="bg-white shadow-md rounded-2xl p-6 border-t-4 border-[#0077FF] hover:shadow-xl transition">
              ...
              <p className="mt-2 text-sm text-gray-600">
                Select your Doctor, pick an Appointment Date and Time that fits your schedule.
              </p>
            </div>
            <div className="bg-white shadow-md rounded-2xl p-6 border-t-4 border-[#004AAD] hover:shadow-xl transition">
              <h3 className="text-xl font-semibold">Step 3: Confirm & Submit</h3>
              <p className="mt-2 text-sm text-gray-600">
